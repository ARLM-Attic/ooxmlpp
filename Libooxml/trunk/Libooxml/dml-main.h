...
namespace drawingml {
	namespace main {
		...
		//end
			...
			ST_FontCollectionIndex& operator =(const ST_FontCollectionIndex& b);
		...
		//end
			...
			ST_ColorSchemeIndex& operator =(const ST_ColorSchemeIndex& b);
		...
		public:
		//end
			CT_EffectStyleItem(std::shared_ptr<CT_EffectList> _effectLst);
			CT_EffectStyleItem(std::shared_ptr<CT_EffectContainer> _effectDag);
		...
		//end
			...
			ST_AnimationChartBuildType& operator =(const ST_AnimationChartBuildType& b);
		...
		//end
			...
			ST_PresetCameraType& operator =(const ST_PresetCameraType& b);
		...
		public:
			...
			ST_AdjCoordinate& operator =(const ST_AdjCoordinate& b);
