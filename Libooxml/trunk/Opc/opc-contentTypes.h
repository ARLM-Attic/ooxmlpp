...
#ifndef OPC_CONTENT_TYPES_H
#define OPC_CONTENT_TYPES_H
...
namespace package
{
  namespace content_types
  {
    class CT_Types: public ::xml_schema::type
    {
      public:
      // Default
      // 
      typedef ::package::content_types::CT_Default Default_type;
      ...
      typedef ::xsd::cxx::tree::traits< Default_type, wchar_t > Default_traits;
      ...
      // Override
      // 
      typedef ::package::content_types::CT_Override Override_type;
      typedef ::xsd::cxx::tree::sequence< Override_type > Override_sequence;
      typedef Override_sequence::iterator Override_iterator;
      typedef Override_sequence::const_iterator Override_const_iterator;
      typedef ::xsd::cxx::tree::traits< Override_type, wchar_t > Override_traits;

      const Override_sequence&
      Override () const;
      ...
      protected:
      Default_sequence Default_;
      Override_sequence Override_;
    };

    class CT_Default: public ::xml_schema::type
    {
      public:
      // Extension
      // 
      typedef ::package::content_types::ST_Extension Extension_type;
      ...
      // ContentType
      // 
      typedef ::package::content_types::ST_ContentType ContentType_type;
      typedef ::xsd::cxx::tree::traits< ContentType_type, wchar_t > ContentType_traits;

      const ContentType_type&
      ContentType () const;
      ...
      void
      ContentType (::std::auto_ptr< ContentType_type > p);

      // Constructors.
      //
      CT_Default (const Extension_type&,
                  const ContentType_type&);
      ...
      protected:
      ::xsd::cxx::tree::one< Extension_type > Extension_;
      ::xsd::cxx::tree::one< ContentType_type > ContentType_;
    };

    class CT_Override: public ::xml_schema::type
    {
      public:
      // ContentType
      // 
      ...
      // PartName
      // 
      typedef ::xml_schema::uri PartName_type;
      typedef ::xsd::cxx::tree::traits< PartName_type, wchar_t > PartName_traits;
      ...
      // Constructors.
      //
      CT_Override (const ContentType_type&,
                   const PartName_type&);
      ...
      protected:
      ::xsd::cxx::tree::one< ContentType_type > ContentType_;
      ::xsd::cxx::tree::one< PartName_type > PartName_;
    };

    class ST_ContentType: public ::xml_schema::string
    {
      public:
      // Constructors.
      //
      ...
      ST_ContentType (const wchar_t*);

      ST_ContentType (const ::std::wstring&);

      ST_ContentType (const ::xml_schema::string&);
    ...
    class ST_Extension: public ::xml_schema::string
    {
      public:
      // Constructors.
      //
      ...
      ST_Extension (const wchar_t*);

      ST_Extension (const ::std::wstring&);

      ST_Extension (const ::xml_schema::string&);
...
namespace package
{
  namespace content_types
  {
    ...
    ::std::auto_ptr< ::package::content_types::CT_Default >
    Default (::xercesc::InputSource& is,
             ::xml_schema::flags f = 0,
             const ::xml_schema::properties& p = ::xml_schema::properties ());
    ...
    Override (const ::std::wstring& uri,
              ::xml_schema::flags f = 0,
              const ::xml_schema::properties& p = ::xml_schema::properties ());
    ...
    ::std::auto_ptr< ::package::content_types::CT_Override >
    Override (::xercesc::InputSource& is,
              ::xml_schema::flags f = 0,
              const ::xml_schema::properties& p = ::xml_schema::properties ());
...
namespace package
{
  namespace content_types
  {
    ...
    Types (::std::ostream& os,
           const ::package::content_types::CT_Types& x, 
    ...
    Types (const ::package::content_types::CT_Types& x, 
           const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
           ::xml_schema::flags f = 0);
    ...
    void
    Default (::std::ostream& os,
             const ::package::content_types::CT_Default& x, 
             const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
             const ::std::wstring& e = L"UTF-8",
             ::xml_schema::flags f = 0);
    ...
    void
    Default (::xercesc::XMLFormatTarget& ft,
             const ::package::content_types::CT_Default& x, 
             const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
             const ::std::wstring& e = L"UTF-8",
             ::xml_schema::flags f = 0);
    ...
    ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
    Default (const ::package::content_types::CT_Default& x, 
             const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
             ::xml_schema::flags f = 0);
    ...
    void
    Override (::std::ostream& os,
              const ::package::content_types::CT_Override& x, 
              const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
              const ::std::wstring& e = L"UTF-8",
              ::xml_schema::flags f = 0);
    ...
    void
    Override (::xercesc::XMLFormatTarget& ft,
              const ::package::content_types::CT_Override& x, 
              const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
              const ::std::wstring& e = L"UTF-8",
              ::xml_schema::flags f = 0);
    ...
    ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
    Override (const ::package::content_types::CT_Override& x, 
              const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
              ::xml_schema::flags f = 0);

    void
    operator<< (::xercesc::DOMElement&, const CT_Types&);

    void
    operator<< (::xercesc::DOMElement&, const CT_Default&);

    void
    operator<< (::xercesc::DOMElement&, const CT_Override&);

    void
    operator<< (::xercesc::DOMElement&, const ST_ContentType&);

    void
    operator<< (::xercesc::DOMAttr&, const ST_ContentType&);

    void
    operator<< (::xml_schema::list_stream&,
                const ST_ContentType&);

    void
    operator<< (::xercesc::DOMElement&, const ST_Extension&);

    void
    operator<< (::xercesc::DOMAttr&, const ST_Extension&);
